...
const Login = () => {
    ...
    return (
        <div className="text-white flex flex-col items-center justify-center ">
            <h1 className="font-bold text-4xl mb-6 text-center mt-36">
                Log In to Get Started
            </h1>
            <p className="text-lg  text-center">Your fans are waiting to fuel your creative journey.</p>
            <div className="flex flex-col gap-2 min-h-[85vh] justify-start p-10 space-y-2 md:space-y-0">
                <button
                    className="flex items-center bg-white text-black  border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-White hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                ...
                <button
                    className="flex items-center bg-white text-black border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
